...
sender_username = user_credentials.get((company_id, sender_id), {}).get("username", "Unknown")
sender_password = user_credentials.get((company_id, sender_id), {}).get("password", "Unknown")
